...
test('REMOVE_FROM_CART', () => {
    ...
    // the second item should now be the first in the array (after the first one is removed)
    ...
    // cart is empty and closed (i guess removing the last item in the cart also closes the cart)
